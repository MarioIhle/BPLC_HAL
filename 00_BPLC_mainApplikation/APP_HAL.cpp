...
{//this->printLog("SETUP HARDWARE");
   ...
   {      
      ...
      if(INIT_SUCCSESFUL)
      {
         ...
         //MCU IO´s mappen
         this->extensionCardManager.mapObjectToExtensionCard(&this->APP_HAL.BUZZER,                      MCU_TYPE, EC_ADDR_1, MCU_CHANNEL__BUZZER);  
         this->extensionCardManager.mapObjectToExtensionCard(&this->APP_HAL.ENCODER,                     MCU_TYPE, EC_ADDR_1, MCU_CHANNEL__ENCODER); 
         this->extensionCardManager.mapObjectToExtensionCard(&this->APP_HAL.OEN,                         MCU_TYPE, EC_ADDR_1, MCU_CHANNEL__OEN); 
         this->extensionCardManager.mapObjectToExtensionCard(&this->APP_HAL.LD1_DEVICE_STATE,            MCU_TYPE, EC_ADDR_1, MCU_CHANNEL__LD1); 
         this->extensionCardManager.mapObjectToExtensionCard(&this->APP_HAL.LD2_COMMUNICATION_STATE,     MCU_TYPE, EC_ADDR_1, MCU_CHANNEL__LD2); 
         this->extensionCardManager.mapObjectToExtensionCard(&this->APP_HAL.LD3_ERROR_OUT,               MCU_TYPE, EC_ADDR_1, MCU_CHANNEL__LD3);  
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_AIN11__COUNT; CARD_ADDR++)
   {
      ...
      {  
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__AIN11revA, (e_EC_ADDR_t)CARD_ADDR);
      }
   }   
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_DIN11__COUNT; CARD_ADDR++)
   {
      ...
      {   
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__DIN11revA, (e_EC_ADDR_t)CARD_ADDR);  
      }             
   }
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_DO11__COUNT; CARD_ADDR++)
   {
      ...
      {        
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__DO11revA, (e_EC_ADDR_t)CARD_ADDR);           
      }
   }
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_REL11__COUNT; CARD_ADDR++)
   {
      ...
      {
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__REL11revA, (e_EC_ADDR_t)CARD_ADDR);
      }
   }
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_MOT11__COUNT; CARD_ADDR++)
   {
      ...
      {
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__MOT11revA, (e_EC_ADDR_t)CARD_ADDR);
      }
   }
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_TMP11__COUNT; CARD_ADDR++)
   {
      ...
      {
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__TMP11revA, (e_EC_ADDR_t)CARD_ADDR);
      }
   }
   ...
   for (uint8_t CARD_ADDR = 0; CARD_ADDR < I2C_ADDRESS_PPO11__COUNT; CARD_ADDR++)
   {
      ...
      {
         this->extensionCardManager.addNewExtensionCard(BPLC_CARD__PPO11revA, (e_EC_ADDR_t)CARD_ADDR);
      }
   }
