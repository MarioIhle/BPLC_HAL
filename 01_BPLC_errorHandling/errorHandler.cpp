...
BPLC_errorManager::BPLC_errorManager()
{
...
e_BPLC_ERROR_t BPLC_errorManager::getError()
{
    return this->error.errorCode;  
}    
void BPLC_errorManager::setError(const e_BPLC_ERROR_t ERROR_CODE, String FILE, const uint16_t LINE)
{
...
void BPLC_errorManager::resetError(String FILE, const uint16_t LINE)
{
    this->error.errorCode       = BPLC_ERROR__NO_ERROR;
    this->error.timestamp       = 0;
    this->error.file            = "";
